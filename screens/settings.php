...
<div class="wrap about-wrap wpn-about-page">
	<h1>WP Push Notification - <strong>Settings</strong></h1>

	<div class="about-text">Please setup your AUTH Token and Project ID so you can get the plugin up and running.</div>
	<div class="wp-badge">Version 1.0.0</div>

	<h2 class="nav-tab-wrapper">
		<a href="<?php echo admin_url( 'admin.php?page=wpn-welcome' ); ?>" class="nav-tab wpn-nav-tab">About</a>
		<a href="<?php echo admin_url( 'admin.php?page=wpn-settings' ); ?>" class="nav-tab wpn-nav-tab nav-tab-active">Settings</a>
